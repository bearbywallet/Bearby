...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get restoreRKStorageAccountsPrompt =>
      'Аккаунты для переноса в ZilPay 2.0. Введите пароль.';
  ...
  String get secretKeyGeneratorPageBackupCheckbox =>
      'Я сделал резервную копию секретного ключа';
  ...
  String get securityPageEnsDomains =>
      'Показывать ENS домены в адресной строке';

  @override
  String get securityPageEnsDescription =>
      'Имейте в виду, что использование этой функции раскрывает ваш IP-адрес сторонним сервисам IPFS.';
  ...
  String get securityPageIpfsDescription =>
      'Bearby использует сторонние сервисы для отображения изображений ваших NFT, хранящихся в IPFS, информации, связанной с ENS(ZNS) адресами в адресной строке браузера, и получения иконок для различных токенов. Ваш IP-адрес может быть раскрыт этим сервисам при их использовании.';
  ...
  String get securityPageTokensFetcherDescription =>
      'Настройка получения токенов на странице безопасности. Если включена, токены будут автоматически запрашиваться с сервера и могут быть добавлены.';
  ...
  String get securityPageNodeDescription =>
      'Отправлять запросы на сервер Bearby для получения лучшего узла';
  ...
  String get securityPageClearImageCacheDescription =>
      'Удалить все кэшированные изображения из временного хранилища';
  ...
  String get revealSecretKeyScamAlertMessage =>
      'Никогда не делитесь своим секретным ключом с кем-либо. Никогда не вводите его на каких-либо сайтах.';
  ...
  String get revealSecretKeyRevealAfter =>
      'Ваш секретный ключ будет раскрыт через:';
  ...
  String get appearanceSettingsPageCompactNumbersDescription =>
      'Включите для отображения сокращенных чисел (например, 20K вместо 20,000).';
  ...
  String get appearanceSettingsPageDeviceSettingsDescription =>
      'По умолчанию использовать настройки устройства. Тема кошелька будет автоматически настраиваться в соответствии с системными настройками.';
  ...
  String get appearanceSettingsPageDarkModeDescription =>
      'Всегда использовать темную тему, независимо от настроек устройства.';
  ...
  String get appearanceSettingsPageLightModeDescription =>
      'Всегда использовать светлую тему, независимо от настроек устройства.';
  ...
  String get secretKeyRestorePageBackupLabel =>
      'Я сделал резервную копию моего секретного ключа';
  ...
  String get addAccountPageBiometricReason =>
      'Пройдите аутентификацию для создания нового аккаунта';
  ...
  String get addressBookPageEmptyMessage =>
      'Ваши контакты и их адреса кошельков\nпоявятся здесь.';
  ...
  String get notificationsSettingsPagePushDescription =>
      'Получать уведомления о отправке и подтверждении транзакций, уведомления от подключенных приложений.';
  ...
  String get revealSecretPhraseRevealAfter =>
      'Ваша секретная фраза будет раскрыта через:';
  ...
  String get revealSecretPhraseScamAlertDescription =>
      'Никогда не делитесь своей секретной фразой с кем-либо. Никогда не вводите её на каких-либо сайтах.';
  ...
  String get cipherSettingsPageStandardDescription =>
      'Базовое шифрование с AES-256 и стандартом ГОСТ КУЗНЕЧИК.';
  ...
  String get cipherSettingsPageHybridDescription =>
      'Гибридное шифрование, комбинирующее алгоритмы CYBER и КУЗНЕЧИК-ГОСТ.';
  ...
  String get cipherSettingsPageQuantumSubtitle =>
      'CYBER + КУЗНЕЧИК + NTRUP1277';

  @override
  String get cipherSettingsPageQuantumDescription =>
      'Продвинутое квантово-устойчивое шифрование с NTRUP1277.';

  @override
  String get cipherSettingsPageQuantumWarning =>
      'Квантово-устойчивое шифрование может повлиять на производительность';
  ...
  String get proceedDespiteInvalidChecksum =>
      'Продолжить, несмотря на ошибку контрольной суммы?';
  ...
  String get passwordSetupPageEmptyWalletNameError =>
      'Название кошелька не может быть пустым';

  @override
  String get passwordSetupPageLongWalletNameError =>
      'Название кошелька слишком длинное';
  ...
  String get passwordSetupPageAuthReason =>
      'Пожалуйста, пройдите аутентификацию для быстрого доступа';
  ...
  String get browserSettingsSearchEngineDescription =>
      'Настройте поисковую систему по умолчанию';
  ...
  String get browserSettingsContentBlockingDescription =>
      'Настройте параметры блокировки контента';
  ...
  String get browserSettingsCookiesDescription =>
      'Разрешить сайтам сохранять и читать куки';
  ...
  String get browserSettingsDoNotTrackDescription =>
      'Запрашивать у сайтов не отслеживать ваш просмотр';
  ...
  String get browserSettingsIncognitoModeDescription =>
      'Просмотр без сохранения истории и куков';
  ...
  String get browserSettingsClearCookiesDescription =>
      'Удалить все куки, сохраненные веб-сайтами';
  ...
  String get browserSettingsClearCacheDescription =>
      'Удалить временные файлы и изображения, сохраненные во время просмотра';
  ...
  String get browserSettingsClearLocalStorageDescription =>
      'Удалить данные веб-сайтов, хранящиеся локально на вашем устройстве';

  @override
  String get browserSettingsCacheDescription =>
      'Хранить данные веб-сайтов для более быстрой загрузки';
  ...
  String get genWalletOptionsPrivateKeySubtitle =>
      'Создать только один приватный ключ';
  ...
  String get addWalletOptionsExistingWalletSubtitle =>
      'Импортировать кошелек с секретной фразой';
  ...
  String get addWalletOptionsWatchAccountSubtitle =>
      'Для мониторинга активности кошелька без фразы восстановления';
  ...
  String get currencyConversionEngineDescription =>
      'Источник получения курсов валют';

  @override
  String get currencyConversionEngineSelectorTitle =>
      'Выбрать источник курсов валют';
  ...
  String get restoreWalletOptionsBIP39Subtitle =>
      'Восстановить с помощью мнемонической фразы';
  ...
  String get restoreWalletOptionsPrivateKeySubtitle =>
      'Восстановить с помощью приватного ключа';
  ...
  String get restoreWalletOptionsKeyStoreSubtitle =>
      'Восстановление кошелька с помощью зашифрованного паролем файла резервной копии';
  ...
  String get restoreWalletOptionsQRCodeSubtitle =>
      'Восстановить кошелек сканированием QR-кода';
  ...
  String get argonSettingsModalContentLowMemoryDescription =>
      'Минимальное использование памяти, подходит для устройств с низкими характеристиками.';
  ...
  String get argonSettingsModalContentOwaspDescription =>
      'Рекомендовано OWASP для общего использования.';
  ...
  String get argonSettingsModalContentSecureDescription =>
      'Высокая безопасность с увеличенной памятью и итерациями.';

  @override
  String get argonSettingsModalContentSecretHint =>
      'Введите секрет (опционально)';
  ...
  String get confirmTransactionContentFailedLoadTransfer =>
      'Не удалось загрузить детали перевода';
  ...
  String get addChainModalContentWarning =>
      'Остерегайтесь сетевых мошенничеств и рисков безопасности.';
  ...
  String get addAddressModalDescription =>
      'Введите имя контакта и адрес кошелька для добавления в адресную книгу.';
  ...
  String get signMessageModalContentAuthReason =>
      'Пожалуйста, авторизуйтесь для подписи сообщения';
  ...
  String get signMessageModalContentDescription =>
      'Просмотрите и подпишите следующее сообщение с помощью вашего кошелька.';
  ...
  String get deleteWalletModalWarning =>
      'Внимание: Это действие нельзя отменить. Ваш кошелек можно восстановить только с помощью секретной фразы. Если у вас нет к ней доступа, вы навсегда потеряете все средства, связанные с этим аккаунтом.';

  @override
  String get deleteWalletModalSecretPhraseWarning =>
      'Пожалуйста, убедитесь, что у вас есть доступ к вашей секретной фразе, прежде чем продолжить.';
  ...
  String get changePasswordModalDescription =>
      'Введите ваш текущий пароль и выберите новый пароль для обновления безопасности вашего кошелька.';
  ...
  String get watchAssetModalContentDescription =>
      'Просмотрите и добавьте следующий токен, предложенный приложением.';
  ...
  String get secretRecoveryModalRevealPhraseDescription =>
      'Если вы когда-либо смените браузер или компьютер, вам понадобится эта секретная фраза восстановления для доступа к вашим аккаунтам. Сохраните её в безопасном и секретном месте.';
  ...
  String get secretRecoveryModalShowKeysDescription =>
      'Внимание: Никогда не раскрывайте этот ключ. Любой, кто имеет ваши приватные ключи, может украсть любые активы, хранящиеся на вашем аккаунте.';
  ...
  String get secretRecoveryModalKeystoreBackupTitle =>
      'Резервное копирование Keystore';

  @override
  String get secretRecoveryModalKeystoreBackupDescription =>
      'Сохраните ваши приватные ключи в зашифрованном файле keystore, защищенном паролем. Это обеспечивает дополнительный уровень безопасности для вашего кошелька.';
  ...
  String get backupConfirmationContentTitle =>
      'Подтверждение резервного копирования';

  @override
  String get backupConfirmationWarning =>
      'ВНИМАНИЕ: Если вы потеряете или забудете вашу seed-фразу в точном порядке, вы навсегда потеряете ваши средства. Никогда не делитесь вашей seed-фразой с кем-либо, иначе ваши средства могут быть украдены. Восстановление BIP39 очень строгое - любая ошибка в словах при восстановлении приведет к потере средств.';
  ...
  String get backupConfirmationContentSafelyStored =>
      'Я надежно сохранил резервную копию';

  @override
  String get backupConfirmationContentWontLose =>
      'Я уверен, что не потеряю резервную копию';

  @override
  String get backupConfirmationContentNotShare =>
      'Я понимаю, что нельзя делиться этими словами с кем-либо';
  ...
  String get keystoreBackupWarningMessage =>
      'Файл keystore содержит ваши зашифрованные приватные ключи. Храните этот файл в безопасном месте и никогда не передавайте его никому. Для расшифровки этого файла вам понадобится созданный вами пароль.';
  ...
  String get keystoreBackupSuccessMessage =>
      'Ваш файл keystore был создан. Обязательно храните в безопасности как файл, так и ваш пароль.';
  ...
  String get keystoreRestoreExtError =>
      'Пожалуйста, выберите действительный файл .zp';
  ...
  String get editGasDialogInvalidGasValues =>
      'Недопустимые значения газа. Проверьте ваши данные.';
  ...
  String get transactionHistoryDescription =>
      'Показывать адреса из истории транзакций';
  ...
  String get ledgerConnectPageNoDevicesFound =>
      'Устройства не найдены. Убедитесь, что Ledger включен, разблокирован и Bluetooth/USB активен.\nПотяните вниз или используйте значок обновления для повторного сканирования.';
  ...
  String get web3ErrorRequestInProgress =>
      'Аналогичный запрос уже обрабатывается';

  @override
  String get web3ErrorNotConnected =>
      'Этот домен не подключен. Пожалуйста, подключитесь сначала.';
  ...
  String get web3ErrorAddressNotAuthorized =>
      'Запрашиваемый адрес не авторизован';
  ...
  String get web3ErrorPermissionNotSupported =>
      'Поддерживается только разрешение eth_accounts';

  @override
  String get web3ErrorNotAuthorizedSuggestTokens =>
      'Этот домен не авторизован для предложения токенов.';

  @override
  String get web3ErrorInvalidTokenType =>
      'Недопустимые параметры для wallet_watchAsset. Ожидается тип токена ERC20.';

  @override
  String get web3ErrorMissingTokenFields =>
      'Отсутствуют обязательные поля: address, symbol или decimals.';

  @override
  String get web3ErrorMissingChainFields =>
      'Отсутствуют обязательные поля для wallet_addEthereumChain';

  @override
  String get web3ErrorNoValidRpcUrls =>
      'Не предоставлены действительные HTTP RPC URL';

  @override
  String get web3ErrorMissingChainId =>
      'Отсутствует обязательное поле: chainId';

  @override
  String get web3ErrorChainNotAdded =>
      'Запрашиваемая сеть не была добавлена. Сначала используйте wallet_addEthereumChain.';
  ...
  String get bip49Description =>
      'P2WPKH-nested-in-P2SH - Адреса начинаются с 3';
  ...
  String get qrCodeUnrecognizedError =>
      'QR-код не распознан. Используйте поддерживаемый формат.';
  ...
  String get qrCodeInvalidWordsError =>
      'QR-код содержит недопустимые слова BIP39.';

  @override
  String get qrCodeInvalidKeyError =>
      'QR-код содержит недопустимый приватный ключ.';
  ...
  String get restoreWalletOptionsPrivateKeyDeprecatedSubtitle =>
      'Устарело для Bitcoin. Используйте BIP39.';
}
