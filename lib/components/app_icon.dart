...
class AppIconView extends StatelessWidget {
  ...
  static List<List<Object?>> _glyphFor(AppIcon icon) => switch (icon) {
        ...
        AppIcon.gear => HugeIcons.strokeRoundedSettings05,
        AppIcon.globe => HugeIcons.strokeRoundedGlobe02,
        AppIcon.graph => HugeIcons.strokeRoundedChart,
        AppIcon.history => HugeIcons.strokeRoundedClock01,
        ...
        AppIcon.lock => HugeIcons.strokeRoundedFingerPrint,
        AppIcon.lockWallet => HugeIcons.strokeRoundedFingerPrint,
        ...
        AppIcon.nav => HugeIcons.strokeRoundedDiscoverCircle,
        ...
        AppIcon.scan => HugeIcons.strokeRoundedScan,
        AppIcon.receive => HugeIcons.strokeRoundedArrowDownLeft01,
        AppIcon.reload => HugeIcons.strokeRoundedReload,
        AppIcon.search => HugeIcons.strokeRoundedSearch01,
        AppIcon.send => HugeIcons.strokeRoundedArrowUpRight01,
        ...
        AppIcon.theme => HugeIcons.strokeRoundedSun03,
        ...
        AppIcon.wallet => HugeIcons.strokeRoundedPurse,
