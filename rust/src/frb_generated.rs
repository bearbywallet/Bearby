...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -225142557;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        143 => wire__crate__api__token__update_rates_impl(port, ptr, rust_vec_len, data_len),
        144 => wire__crate__api__transaction__update_tx_with_params_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        145 => wire__crate__api__exchange__bootstrap__validate_exchange_providers_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        146 => wire__crate__api__exchange__whitebird__whitebird_create_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        147 => wire__crate__api__exchange__whitebird__whitebird_open_orders_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        148 => wire__crate__api__exchange__whitebird__whitebird_reject_order_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
